...
<title>Insert title here</title>
	...
	*{box-sizing: border-box;}
	#container{margin: 0; padding: 0; width: 1980px; height: 1024px}
	#font{font-family: Cursive;}
	#menu{background: linear-gradient(to right,  #E57733,  #FFA0FF); height: 65px; width: 90%; margin-left: 70px; margin-top: 150px;} 
	...
	#side{float: right; padding: 40px; margin-top: 150px; margin-right: 150px}
...
.map_wrap {position:absolute;width:1050px;height:800px; margin-left: 100px; margin-top: 10px;}
...
<body>
	<div id="container">
		<header id="header" align="center">
			<a href="main2.jsp"><h1 id="font">Special Day</h1></a>
		</header>
...
<script type="text/javascript"src="//dapi.kakao.com/v2/maps/sdk.js?appkey=8b29200571cd51bb1c40495936a1a59d&libraries=services"></script>
			<script>
		...
		var mapContainer = document.getElementById('map'), // 지도를 표시할 div 
		    mapOption = {
		        center: new kakao.maps.LatLng(37.64775029923453, 126.8963515592911), // 지도의 중심좌표
		        level: 5 // 지도의 확대 레벨
		    };  
		...
		function changeCategoryClass(el) {
			...
			<aside id="side"><a href="https://m.shopping.nate.com/#!/category/14"><img src="../image/광고1.png" width="370" height="500"></a></aside>
		<br><br>
		</div>
