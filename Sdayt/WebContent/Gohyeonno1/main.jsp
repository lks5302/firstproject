...
<div id="container">
		<header id="header" align="center" >
			 ...
			 <form action="log.jsp" method="post" name="f1" >
				<table class="tb">
					<h1 id="font">Special Day</h1>
					<tr><th><label for="inputtext">ID</label></th><td>
					<input type="text" id="user_id" name="id" onKeyDown="if(event.keyCode == 13) loginChk()"  />
					</td><td align="center"><input type="submit" value="로그인"  class="btn1" onclick="loginChk()" ></td></tr>
					
				    <tr><th><label for="password">password</label></th><td> 
					<input type="password" name="pass" onKeyDown="if(event.keyCode == 13) loginChk()"></td><td align="center">
					<a href="membership.jsp"><input type="button" value="회원가입" class="btn2"/></a></td></tr>
